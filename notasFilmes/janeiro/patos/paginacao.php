...
$sql_usuario_count_query = "SELECT COUNT(*) as contador FROM patos"; // Pegando a quantidade de usuarios
...
$sql_usuario_query = "SELECT * FROM patos ORDER BY id_usuario_nota DESC LIMIT {$limit} OFFSET {$offset}";
