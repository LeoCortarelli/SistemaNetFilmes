...
$sql_usuario_count_query = "SELECT COUNT(*) as contador FROM wonka"; // Pegando a quantidade de usuarios
...
$sql_usuario_query = "SELECT * FROM wonka ORDER BY id_usuario_nota DESC LIMIT {$limit} OFFSET {$offset}";
