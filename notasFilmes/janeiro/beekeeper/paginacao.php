...
$sql_usuario_count_query = "SELECT COUNT(*) as contador FROM beekeeper"; // Pegando a quantidade de usuarios
...
$sql_usuario_query = "SELECT * FROM beekeeper ORDER BY id_usuaro_nota DESC LIMIT {$limit} OFFSET {$offset}";
