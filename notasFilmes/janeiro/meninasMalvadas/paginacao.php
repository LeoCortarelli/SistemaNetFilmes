...
$sql_usuario_count_query = "SELECT COUNT(*) as contador FROM meninas_malvadas"; // Pegando a quantidade de usuarios
...
$sql_usuario_query = "SELECT * FROM meninas_malvadas ORDER BY id_usuario_nota DESC LIMIT {$limit} OFFSET {$offset}";
