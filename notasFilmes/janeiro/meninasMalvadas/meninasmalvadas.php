...
<head>
    ...
    <link rel="stylesheet" href="../../../css/notasFilmes/janeiro/maninasMalvadas.css">
...
<body>
    ...
    <div>
        <?php
            ...
            $sql  = "SELECT nota, comentario, data_comentario FROM meninas_malvadas ORDER BY id_usuario_nota desc";
