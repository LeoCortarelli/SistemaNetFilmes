...
$sql_usuario_count_query = "SELECT COUNT(*) as contador FROM aquamem2reinoperdido"; // Pegando a quantidade de usuarios
...
$sql_usuario_query = "SELECT * FROM aquamem2reinoperdido ORDER BY id_usuaro_nota DESC LIMIT {$limit} OFFSET {$offset}";
